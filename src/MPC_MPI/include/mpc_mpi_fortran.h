...
MPI_Message MPI_Message_f2c(MPI_Fint info);
MPI_Fint MPI_Message_c2f(MPI_Message info);
...
MPI_Message PMPI_Message_f2c(MPI_Fint info);
MPI_Fint PMPI_Message_c2f(MPI_Message info);
