...
static inline void setup_binary_tree(MPI_Comm comm,
                                     int root,
                                     int *out_rank,
                                     int *out_size,
                                     int *out_parent,
...
int MPI_Ixscatter(const void *sendbuf,
                  int sendcount,
...
int MPI_Ixgather(const void *sendbuf,
                 int sendcount,
                 MPI_Datatype sendtype,
                 void *recvbuf,
                 int recvcount,
...
int MPI_Ixreduce(const void *sendbuf,
                 void *recvbuf,
                 int count,
                 MPI_Datatype datatype,
                 MPI_Op op,
