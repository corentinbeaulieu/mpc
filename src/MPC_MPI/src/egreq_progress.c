...
static inline int __mpc_egreq_progress_work_unit_acquire(struct _mpc_egreq_progress_work_unit *pwu,
                                                         int (*fn)(void *param), void *param)
{
...
static inline struct _mpc_egreq_progress_work_unit *__mpc_egreq_progress_list_acquire(
	struct _mpc_egreq_progress_list *pl,
	int (*fn)(void *param),
	void *param)
{
	int acquired = 0;
...
struct _mpc_egreq_progress_work_unit *_mpc_egreq_progress_list_add(struct _mpc_egreq_progress_list *pl,
                                                                   int (*fn)(void *param), void *param)
{
