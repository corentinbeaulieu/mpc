                                              ...
                                              int(**out_func)())
{
	...
	// mpc_common_debug_error("IC %d SHM %d shared %d (IC %p SH %p SHAN %p INT %p", is_intercomm, is_shm,
	// is_shared_node, inter, intra_shm, intra_shared_node, intra);
