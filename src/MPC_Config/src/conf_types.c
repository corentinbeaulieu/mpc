...
static inline int __print_enum(char *buff, int len, int *ptr, int add_color, mpc_conf_enum_keyval_t *ekv,
                               int ekv_length)
{
	int index = -1;
...
int mpc_conf_type_print_value(mpc_conf_type_t type,
                              char *buf,
                              int len,
                              void *ptr,
                              int add_color,
...
int __mpc_conf_type_parse_from_string(mpc_conf_type_t type,
                                      void *dest,
                                      char *from,
                                      mpc_conf_enum_keyval_t *ekv,
                                      int ekv_length)
...
int mpc_conf_type_set_value_from_string(mpc_conf_type_t type,
                                        void **dest,
                                        char *from,
                                        mpc_conf_enum_keyval_t *ekv,
                                        int ekv_length)
