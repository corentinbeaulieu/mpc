...
/** ** **/
static td_err_e (*td_thr_getfpregs_p)(const td_thrhandle_t *th_p,
				      prfpregset_t *fpregset);
static td_err_e (*td_thr_setfpregs_p)(const td_thrhandle_t *th_p,
				      const prfpregset_t *fpregset);
static td_err_e (*td_thr_getgregs_p)(const td_thrhandle_t *th_p,
				     prgregset_t regset);
static td_err_e (*td_thr_setgregs_p)(const td_thrhandle_t *th_p,
