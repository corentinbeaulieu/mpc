...
typedef union
{
	...
	} mpi;                                                 /**< These parameters are required to create SHM segments
	                                                        * with MPI */
 ...
 *          - With @ref MPC_LAUNCH_SHM_USE_MPI, the user should provide a communicator spanning on a single node
 *(analogous to MPI_COMM_TYPE_SHARED)
 */
